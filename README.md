...
- [X] Implement CRUD operations for add-ons (e.g., extra time, additional packages).
- [X] Associate add-ons with specific bookings and adjust booking totals accordingly.
- [X] ***Finished the Add-ons Management Section***
